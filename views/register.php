    ...
    <div class="signup-box">
        ...
        <form action="/register" method="POST">
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<?=$_SESSION['old_values']['username'] ?? ''?>"/>
            ...
            <div class="form-group">
                ...
                <input type="password" id="confirm_password" name="confirm_password" value="<?=$_SESSION['old_values']['confirm_password'] ?? ''?>"/>
